 ...
 * state_t is received.
 */
typedef void(*state_t_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const state_t *msg, void *userdata);
 ...
 */
state_t_subscription_t* state_t_subscribe(
    lcm_t *lcm, const char *channel, state_t_handler_t handler, void *userdata);
 ...
 * @return 0 on success, <0 if an error occured
 */
int state_t_subscription_set_queue_capacity(
    state_t_subscription_t* subs, int num_messages);
...
int __state_t_encode_array(
    void *buf, int offset, int maxlen, const state_t *p, int elements);
int __state_t_decode_array(
    const void *buf, int offset, int maxlen, state_t *p, int elements);
